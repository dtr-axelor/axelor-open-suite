...
public class ThenDefinitions extends AbsDefinitions {
	...
	@Then("^the" + WIDGET_ORDINAL + " field" + ATTRIBUTE + VALUE + " should have value" + VALUE + WAIT + "$")
	public void checkFieldValue(Integer ordinal, String locatingMechanism, String attributeValue, String expectedValue,
			String shouldWait, Integer waitingTime) throws InterruptedException {
	...
	@Then("^the" + WIDGET_ORDINAL + " pop-up" + ATTRIBUTE + VALUE + " should have value" + VALUE + WAIT + "$")
	public void checkPopupText(Integer ordinal, String locatingMechanism, String attributeValue, String expectedValue,
			String shouldWait, Integer waitingTime) throws InterruptedException {
		WebElement element = findElementBy(ordinal, locatingMechanism, attributeValue, null);
...
//				getActiveStatusElement(findElementBy(null, attributeName, attributeValue, null)), expectedStatus));
	...
	@Then("^the" + WIDGET_ORDINAL + " (field|panel|tab|button)" + ATTRIBUTE + VALUE + " should be" + PROPERTY + "$")
	public void checkQualifier(Integer ordinal, String object, String attributeName, String attributeValue,
	...
	public void checkNumOfElements(String attributeName, String attributeValue, int expectedElementCount) {
		List<WebElement> elements = driver.findElements(By.cssSelector(attributeValue));

		Integer actualElementCount = elements.size();
		Assert.assertTrue("Check if a field has the expected number of elements.\nExpected: " + expectedElementCount
				+ "\nActual: " + actualElementCount, actualElementCount.equals(expectedElementCount));
	}
